...
class ShopDropTest {
    ...
    @Test
    void whenIndexOneThanDeleteFirstElement() {
        ...
        Product[] products = new Product[] {milk, chocolate, tomato, bread, cheese};
        Product[] result = ShopDrop.delete(products, 0);
        assertThat(result[0].getName()).isEqualTo("chocolate");
        assertThat(result[result.length - 1]).isNull();
    }
